...
# 
bash run.sh train TransE FB15k 2 0 1024 256 125 24.0 1.0 0.0001 150000 16
bash run.sh train TransE FB15k-237 2 0 1024 256 125 9.0 1.0 0.00005 100000 16
bash run.sh train TransE wn18 2 0 512 1024 125 12.0 0.5 0.0001 80000 8
bash run.sh train TransE wn18rr 2 0 512 1024 125 6.0 0.5 0.00005 80000 8
